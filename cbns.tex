...
\begin{align}
    ...
    \RV{Y}_i\CI_{\prob{Q}} \RV{V}_{[m]\setminus \{i\}}|\RV{HX}_i&\forall i\in [m]\label{eq:cbn_ci3}\\
\end{align}
and
\begin{align}
...
\subsubsections{Properties of CBN probability gap models}
...
Together with Equations \ref{eq:cbn_ci1} and \ref{eq:cbn_ci2}, we have 

\begin{align}
    \prob{Q}^{\RV{V}_i|\RV{H}\RV{V}_{[m]\setminus\{i\}}}&=\prob{Q}^{\RV{V}_i|\RV{H}}\otimes \text{erase}_\\
    \prob{Q}
\end{align}

Equation \ref{eq:cbn_insert} implies
